...
mstimes = [
    datetime.timedelta(hours=10,minutes=30,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=30,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=31,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=33,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=35,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=37,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=40,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=50,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=00,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=20,seconds=30).total_seconds(),                     
]
