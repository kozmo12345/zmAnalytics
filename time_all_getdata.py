...
mstimes = [
    datetime.timedelta(hours=10,minutes=00,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=00,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=1,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=1,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=2,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=2,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=3,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=3,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=4,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=4,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=5,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=5,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=6,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=6,seconds=30).total_seconds(),
    datetime.timedelta(hours=10,minutes=7,seconds=00).total_seconds(),
    datetime.timedelta(hours=10,minutes=7,seconds=30).total_seconds(),    
    datetime.timedelta(hours=11,minutes=00,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=00,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=1,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=1,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=2,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=2,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=3,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=3,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=4,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=4,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=5,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=5,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=6,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=6,seconds=30).total_seconds(),
    datetime.timedelta(hours=11,minutes=7,seconds=00).total_seconds(),
    datetime.timedelta(hours=11,minutes=7,seconds=30).total_seconds()      
]
