...
mstimes = [
    ...
    datetime.timedelta(hours=9,minutes=4,seconds=40).total_seconds(),
    datetime.timedelta(hours=9,minutes=6,seconds=00).total_seconds(),
    datetime.timedelta(hours=9,minutes=6,seconds=30).total_seconds()
]

dataFile = open(os.path.join("C:\\", "Data\\alldata4" + ".txt"), 'w')
