...
for dirname, dirnames, filenames in os.walk("C:\\Dropbox\\com_2\\Data\\"):
    for subdirname in dirnames:
        ...
        print(today)
        setFile = open(os.path.join("C:\\", "Dropbox\\com_2\\Data\\" + today + "\\" + today + "moa4.txt"), 'w')
...
analFilePath = os.path.join("C:\\", "Dropbox\\com_2\\Data\\" + "anal2.txt");
...
for dirname, dirnames, filenames in os.walk("C:\\Dropbox\\com_2\\Data\\"):
    for subdirname in dirnames:
        ...
        setFilePath = os.path.join("C:\\", "Dropbox\\com_2\\Data\\" + today + "\\" + today + "moa4.txt");
