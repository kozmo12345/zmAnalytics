            ...
            try:
                ...
                if(bool_oTime == True):
                    ...
                    for code in (codes):
                        ...
                        if(code.decode('utf-8') in delayMesu and delayMesu[code.decode('utf-8')] + 6 > i and grRate < 1 and (int(exportData[i, 4].decode('UTF-8')) - int(exportData[i-1, 4].decode('UTF-8'))) > 1000 and code not in comps):
