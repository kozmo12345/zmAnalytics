...
mdFilePath = os.path.join("C:\\", "Dropbox\\Data\\" + "analmd.txt");
mdFilePath = open(mdFilePathPath, 'w')

analFilePath = os.path.join("C:\\", "Dropbox\\Data\\" + "anal.txt");

analdata = sp.genfromtxt(analFilePath, delimiter=",", dtype='|S20')
dates = analdata[:,0]
codes = analdata[:,1]
