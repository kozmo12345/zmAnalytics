            ...
            try:
                ...
                if(bool_oTime == True):
                    ...
                    for code in (codes):
                        ...
                        if(((ms_md > 0.96 and sms_md > 1 and gr > 420000) or (ms_md < 0.96 and sms_md < 1 and chegang > 163) or (cggrad > 2.3 and chegang > 163)) and grade < 16 and exportData[i, 3].astype(float) > 5):
                            x = ti
